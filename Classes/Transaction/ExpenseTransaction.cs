//en sub-class (som ärver från) till TransactionBase, som består av de ingående detaljerna i en transaktion, tex räkningar (för kostnader/utgifter)
...
//är en instans/ett objekt som genereras från Base-Classen och är fördefinerad med de argument som användes för en transaktion, av användaren vid varje ny transaktion, dvs, transaktions beskrivning, transaktionsbelopp, transaktionsdatum, när Constructorn anropades 
public class ExpenseTransaction : TransactionBase
{
  ...
  public ExpenseTransaction(string descriptionStr, decimal amountDecimal, DateTime dateDateTime) : base(descriptionStr, amountDecimal, dateDateTime) // anropar Base-Constructorn 
  {    
  }
